  ...
  <div class="lime-explanation">
    ...
    <div class="feature-list">
      ...
      <div v-if="loading" class="text-center py-4">
        ...
        <p class="mt-2 text-muted">Generating LIME explanation...</p>
      </div>
      ...
      <div v-else-if="!limeExplanation" class="text-center py-4">
        <i class="fas fa-lightbulb mb-2" style="font-size: 2rem; color: #ddd;"></i>
        <p class="text-muted mb-3">LIME explanation not loaded yet</p>
